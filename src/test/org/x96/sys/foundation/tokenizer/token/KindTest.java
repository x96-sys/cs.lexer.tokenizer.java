...
public class KindTest {
    @Test
    void happyIs() {
        assertEquals(Kind.is(-3), Kind.UNKNOWN);
        assertEquals(Kind.is(-2), Kind.UNKNOWN);
        assertEquals(Kind.is(-1), Kind.UNKNOWN);
        ...
        assertEquals(Kind.is(0x80), Kind.UNKNOWN);
        assertEquals(Kind.is(0x81), Kind.UNKNOWN);
    }
